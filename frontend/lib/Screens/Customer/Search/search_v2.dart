...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void _submitSearch(String query) async {
    try {
      print('Applying filters: brands=$_selectedBrands, minPrice=$_minPrice, maxPrice=$_maxPrice, category=$_selectedCategory');
              ...
              if (_searchResults.isNotEmpty) ...[
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final imageUrl = product.images.isNotEmpty ? product.images[0].url : null;
                    return Card(
                      elevation: 2,
